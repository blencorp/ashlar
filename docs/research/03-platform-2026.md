...
This document records what the modern web platform delivers in 2026 and what JavaScript a design system can therefore stop shipping. It is the empirical foundation for Atrium's L0 (platform-driven foundation) layer.
...
The 70/30 split is the empirical foundation for Atrium's two-layer separation:
...
This split keeps the bundle small, the maintenance surface small, and the cross-stack reach maximal. It also means a federal Drupal site can adopt 70% of Atrium without taking on any JavaScript runtime at all.
